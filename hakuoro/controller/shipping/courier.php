...
class ControllerShippingCourier extends Controller {
    ...
    public function index() {
        ...
        $this->data['entry_delivery_price_zone1'] = $this->language->get('entry_delivery_price_zone1');
	    $this->data['entry_delivery_price_zone2'] = $this->language->get('entry_delivery_price_zone2');
	    $this->data['entry_delivery_price_zone3'] = $this->language->get('entry_delivery_price_zone3');
        ...
        if (isset($this->request->post['courier_delivery_price_zone1'])) {
            $this->data['courier_delivery_price_zone1'] = $this->request->post['courier_delivery_price_zone1'];
        } else {
            $this->data['courier_delivery_price_zone1'] = $this->config->get('courier_delivery_price_zone1');
        }
		
		if (isset($this->request->post['courier_delivery_price_zone2'])) {
            $this->data['courier_delivery_price_zone2'] = $this->request->post['courier_delivery_price_zone2'];
        } else {
            $this->data['courier_delivery_price_zone2'] = $this->config->get('courier_delivery_price_zone2');
        }
		
		if (isset($this->request->post['courier_delivery_price'])) {
            $this->data['courier_delivery_price_zone3'] = $this->request->post['courier_delivery_price_zone3'];
        } else {
            $this->data['courier_delivery_price_zone3'] = $this->config->get('courier_delivery_price_zone3');
        }
