...
<head>
    ...
    <?php } ?>
    <link rel="stylesheet" type="text/css" href="catalog/view/theme/lite_blue_152/stylesheet/stylesheet.css"/>
    ...
    <?php } ?>
    <!--[if IE 7]>
    <link rel="stylesheet" type="text/css" href="catalog/view/theme/lite_blue_152/stylesheet/ie7.css"/>
    <![endif]-->
    <!--[if lt IE 7]>
    <link rel="stylesheet" type="text/css" href="catalog/view/theme/lite_blue_152/stylesheet/ie6.css"/>
