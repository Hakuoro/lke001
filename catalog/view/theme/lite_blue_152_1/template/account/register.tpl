...
<div id="content"><?php echo $content_top; ?>
    ...
    <form action="<?php echo $action; ?>" method="post" name="form" id="the_form" enctype="multipart/form-data">
        ...
        <div class="buttons">
            <div class="right"><?php echo $text_agree; ?>
                <?php if ($agree) { ?>
                    ...
                    <?php } ?>
                <input type="submit" value="<?php echo $button_continue; ?>" class="button validate"/>
...
<script type="text/javascript" src="catalog/view/javascript/jquery/jquery.ajaxValidation.js"></script>
...
$(document).ready(function(){
    ...
    $('#the_form').ajaxValidation({
        ...
        afterValidate: function(hasError, message){
    ...
    /*$('.validate').click(function(){
        $('#the_form').ajaxValidation('validate');
    });*/
});
