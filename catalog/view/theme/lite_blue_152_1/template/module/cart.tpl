<div id="cart">
    <div class="heading">
        ...
        <div style="color: black; text-align: right; font-size: 22px; margin-bottom: 7px;">+7(926) 361-61-35</div>
    ...
    <div class="content">
        ...
        <div class="checkout"><a href="<?php echo $cart; ?>"><?php echo $text_cart; ?></a> | <a
