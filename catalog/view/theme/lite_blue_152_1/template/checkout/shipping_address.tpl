    ...
    <select name="address_id" style="width: 100%; margin-bottom: 15px;" size="5">
        ...
        <?php if ($address['address_id'] == $address_id) { ?>
            <option value="<?php echo $address['address_id']; ?>"
                    selected="selected"><?php echo $address['firstname']; ?> <?php echo $address['lastname']; ?>, <?php echo $address['country']; ?>, <?php echo $address['city']; ?>, <?php echo $address['address_1']; ?></option>
            <?php } else { ?>
            <option
    ...
    <table class="form">
        ...
        <tr>
            ...
            <td><select name="country_id" class="large-field"
                        onchange="$('#shipping-address select[name=\'zone_id\']').load('index.php?route=checkout/shipping_address/zone&country_id=' + this.value);">
...
<br/>
<div class="buttons">
    <div class="right"><input type="button" value="<?php echo $button_continue; ?>" id="button-shipping-address"
                              class="button"/></div>
</div>
