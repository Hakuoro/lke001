...
<div id="content"><?php echo $content_top; ?>
    <div class="typo-styles__demo mdl-typography--headline"><?php echo $heading_title; ?></div><br/>

<div class="product-info">
<?php if ($thumb || $images) { ?>
<div class="left">
    <?php if ($thumb) { ?>
    <div class="image"><a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" data-lightbox="main_photo">
    ...
    <div class="image-additional">
        ...
        <a href="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?>" data-lightbox="roadtrip">
...
<div class="cart">
    <div><?php echo $text_qty; ?>
        ...
        &nbsp;
        <button id="button-cart" class="mdl-button mdl-button--colored mdl-button--accent mdl-button--raised mdl-js-button mdl-js-ripple-effect">
...
<div class="review">
    <div><img src="catalog/view/theme/default/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>"/>&nbsp;&nbsp;<a
